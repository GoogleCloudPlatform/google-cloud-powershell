...
Describe "Get-GceInstance" {
	...
	gcloud compute --project "gcloud-powershell-testing" instance-groups managed create "instance-group-$r" `
		--zone "us-central1-a" --base-instance-name "instance-group-$r" --size "1" #>
